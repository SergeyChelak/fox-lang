...
pub enum ErrorKind {
    ...
    ExpectedSemicolon,
    ExpectedRightBrace,
    ExpectedLeftParenthesisAfterIf,
    ExpectedRightParenthesisAfterIfCondition,
...
impl Display for ErrorKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        let text = match self {
            ...
            ExpectedLeftParenthesisAfterIf => "Expect '(' after 'if'",
            ExpectedRightParenthesisAfterIfCondition => "Expect ')' after if condition",
